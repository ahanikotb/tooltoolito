...
function PrivacyPolicy() {
  return (
    ...
    >
      <h1>Privacy Policy for Tooltoolito</h1>

      <p>
        At Tooltoolito, accessible from https://www.tooltoolito.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Tooltoolito and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Tooltoolito. This policy is not applicable to
      ...
      <p>
        Tooltoolito follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Tooltoolito uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of Tooltoolito.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Tooltoolito, which are sent
      ...
      <p>
        Note that Tooltoolito has no access to or control over these cookies
      ...
      <p>
        Tooltoolito's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Tooltoolito does not knowingly collect any Personal Identifiable
